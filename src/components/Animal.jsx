...
// import logaimg from "/icons8-location.gif"

const Animal = ({ animal }) => {
  return (
    <div>
      <div className="bg-[#1a3a0a] border border-[#3B6D11] rounded-xl overflow-hidden hover:border-[#97C459] transition group">
        {/* Image */}
        ...
        <div className="p-4">
          ...
          <div className="flex items-center gap-3 text-[10px] text-[#639922] mb-3">
            <span> <Image src="/icons8-location.gif" alt="Location" width={10} height={10} /> {animal.location}</span>
          </div>
